...
$FileLocation = "D:\Reports\SP2016_SiteReport.csv"
...
foreach($WebApplication in $WebApplications)
{
    ...
    {   
        if($Site -ne $null)
        {
            if( -not($Site.Url.StartsWith("https://mysites","CurrentCultureIgnoreCase")) -and -not($Site.Url.StartsWith("http://feprsp16app","CurrentCultureIgnoreCase")) -and -not($Site.Url.StartsWith("https://sitemaster","CurrentCultureIgnoreCase")) )
            {
...
#Write-EventLog -LogName "Application" -Source "SharePoint Report" -EventID 100 -EntryType Information -Message "Monthly SharePoint 2016 Site Report has been generated and ready for delivery."
